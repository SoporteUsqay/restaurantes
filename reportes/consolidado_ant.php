        ...
        <tbody>
            ...
            if ($hubo_actividad) {
                ...
                <td style="text-align: center;"><b>SUBTOTALES<b></td>
                    ...
                    <td style="text-align: center;"><b></b></td>
                    <td style="text-align: right;"><b><?php echo number_format($s8, 2, '.', ' '); ?></b></td>
                    </tr>
                <tr>
                ...
                <td style="text-align: center;"><b>TOTALES<b></td>
                    ...
                    <td style="text-align: right;"><b><?php echo number_format($s8-(floatval($descuentoConsumo)+floatval($descuentoCredito)+floatval($descuentoVenta)+floatval($descuentoVentaCobrar)), 2, '.', ' '); ?></b></td>
                </tr>
                <?php 
            }
                }
