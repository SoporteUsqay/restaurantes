...
$the_subject = "Alerta de Liberacion de Mesa";
...
$phpmailer->Body .="<h1 style='color:#3498db;'>¡Se Liberó una Mesa!</h1>";
$phpmailer->Body .= "<p>En <b>".$nombre_local."</b> se liberó la mesa <b>".$mesa."</b> del salon <b>".$salon."</b> por <b>".$usuario."</b>, los items presentes a la hora de la liberación son:</p>".$items."<p>El total liberado es de <b>".$moneda."".$total."</b></p>";
