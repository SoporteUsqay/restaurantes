...
$the_subject = "Alerta de Venta por Consumo";
...
$phpmailer->Body .="<h1 style='color:#3498db;'>¡Se registró una Venta por Consumo!</h1>";
$phpmailer->Body .= "<p>En <b>".$nombre_local."</b> se registró la venta #".$pedido." por CONSUMO realizada en la mesa <b>".$mesa."</b> del salon <b>".$salon."</b> por <b>".$usuario."</b>, los items incluidos en la venta son:</p>".$items."<p>El total de la venta es <b>".$moneda."".$total."</b></p>";
if($comprobante <> ""){
    $phpmailer->Body .= "<p>Además con la venta se anuló el comprobante <b>".$comprobante."</b></p>";
}
$phpmailer->Body .= "<p>Cliente: ".$cliente."</p>";
