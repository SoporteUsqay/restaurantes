...
$the_subject = "Alerta de Venta por Credito";
...
$phpmailer->Body .="<h1 style='color:#3498db;'>¡Se registró una Venta por Crédito!</h1>";
$phpmailer->Body .= "<p>En <b>".$nombre_local."</b> se registró la venta #".$pedido." a CRÉDITO realizada en la mesa <b>".$mesa."</b> del salon <b>".$salon."</b> por <b>".$usuario."</b>, los items incluidos en la venta son:</p>".$items."<p>El total de la venta es <b>".$moneda."".$total."</b></p>";
if($comprobante <> ""){
