...
$the_subject = "Alerta de Registro de Movimiento de Caja";
...
$phpmailer->Body .="<h1 style='color:#3498db;'>¡Se Registró un Movimiento de Caja!</h1>";
$phpmailer->Body .= "<p>En <b>".$nombre_local."</b> se registró el movimiento de caja <b>#".$codigo."</b> del tipo <b>".$tipo."</b> por un monto de <b>".$moneda." ".$monto."</b> en <b>".$medio."</b></p>";
$phpmailer->Body .= "<p>El movimiento tiene como comentario '".$comentario."', fue realizado en la caja <b>".$caja."</b> y fue registrado por <b>".$usuario."</b></p>";
