...
class CifrasEnLetras {
  ...
  */
  protected static function convertirUnidades($unidades, $genero='neutro') {
    if ($unidades == 1) {
      if ($genero == 'masculino') return 'y uno';
      elseif ($genero == 'femenino') return 'uno';
    }
    else if ($unidades == 21) {
      if ($genero == 'masculino') return 'veinte y uno';
      elseif ($genero == 'femenino') return 'veinte y uno';
    }
  ...
  */
  protected static function convertirCentenas($centenas, $genero='neutro') {
    ...
    if ($genero == 'femenino') $resultado = str_replace('iento','iento', $resultado);
    return $resultado;
  }
  ...
  */
    ...
    $palabraDecimal='', $palabraDecimalPlural='', $esFemeninaPalabraDecimal=false)
  {
    ...
    if ($esAutomaticoNumeroDecimales) {
      ...
      //$cifrasDecimal = substr($cifrasDecimal, 1, min($numeroDecimales, strlen($cifrasDecimal)));
